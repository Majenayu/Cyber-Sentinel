...
- [SecLists local paths](seclists-paths.md) — user's SecLists folder is SecLists-master (not SecLists); ffuf/gobuster are Go source repos, use wsl binary; confirmed wordlist paths documented
